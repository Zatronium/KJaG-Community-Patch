...
function onAnimationEvent(a)
	...
	local targets = getTargetsInCone(worldPosition, 350, 80, worldFacing, EntityFlags(EntityType.Vehicle, EntityType.Zone, EntityType.Avatar));
	...
	playSound("thundersmash");
	
	for t in targets:iterator() do
		applyDamage(a, t, math.random (60,95));
	end
end