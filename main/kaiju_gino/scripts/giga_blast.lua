...
function onTick(aura)
	...
	if currentTarget then	
		...
		view:doBeamEffectFromNode('eye_node_01', position, 'effects/gigablast_flare.plist', sceneBeamFacing );
		view:doBeamEffectFromNode('eye_node_01', position, 'effects/gigablast_core.plist', sceneBeamFacing );
		view:doBeamEffectFromNode('eye_node_02', position, 'effects/gigablast_flare.plist', sceneBeamFacing);
		view:doBeamEffectFromNode('eye_node_02', position, 'effects/gigablast_core.plist', sceneBeamFacing);
		...
		applyDamageWithWeapon(avatar, currentTarget, "weapon_EyeBeam3");
	else 
		view:doBeamEffectFromNode('eye_node_01', sceneBeamEnd, 'effects/gigablast_flare.plist', sceneBeamFacing );
		view:doBeamEffectFromNode('eye_node_01', sceneBeamEnd, 'effects/gigablast_core.plist', sceneBeamFacing );
		view:doBeamEffectFromNode('eye_node_02', sceneBeamEnd, 'effects/gigablast_flare.plist', sceneBeamFacing);
		view:doBeamEffectFromNode('eye_node_02', sceneBeamEnd, 'effects/gigablast_core.plist', sceneBeamFacing);
		view:doEffectFromNode('eye_node_01', 'effects/gigablast_muzzle.plist', 0);
		view:doEffectFromNode('eye_node_02', 'effects/gigablast_muzzle.plist', 0);
