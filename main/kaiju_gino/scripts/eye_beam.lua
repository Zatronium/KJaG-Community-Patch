...
function onTick(aura)
	...
	if currentTarget then	
		...
		view:doBeamEffectFromNode('eye_node_01', position, 'effects/eyeBeam.plist', sceneBeamFacing );
		view:doBeamEffectFromNode('eye_node_02', position, 'effects/eyeBeam.plist', sceneBeamFacing);
		...
		applyDamageWithWeapon(avatar, currentTarget, "weapon_EyeBeam1");
	else 
