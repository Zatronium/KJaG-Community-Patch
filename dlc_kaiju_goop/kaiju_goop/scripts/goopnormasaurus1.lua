...
function set1(a)
	-- passives first
	GinoPassives(a, 1);
	a:setAbility("ability_Omnigears", -1);
	a:setAbility("ability_HeuristicAlgorithms", -1);
	a:setAbility("ability_AuxiliaryReactor", -1);
	-- actives
	a:setAbility("ability_Plasmoid", 0);
	a:setAbility("ability_PlasmaFire", 1);
	a:setAbility("ability_EyeBeams", 2);
	a:setAbility("ability_DeathStare", 3);
